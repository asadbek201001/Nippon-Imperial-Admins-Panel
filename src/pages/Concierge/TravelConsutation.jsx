...
// Image
import Img4 from "../../images/concierge/Img5.png"; // O'zingizga mos rasmni joylashtiring
...
const TravelConsultation = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const { fullName, phone, email, destination, travelGoals } = formData;
    if (!(fullName && phone && email && destination && travelGoals)) {
  ...
  return (
    <Wrapper>
      <Card>
        <Img src={Img4} alt="travel" onClick={() => setOpen(true)} />
        <Content>
